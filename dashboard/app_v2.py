        ...
        [
            ...
            html.P(
                [
                    ...
                    html.Br(),
                    "في هذا التحليل، بنعرف وين وصلنا في سعودة القطاعات في المملكة العربية السعودية.",
                ]
            ),
            ...
            html.P(
                [
                    "بعد ما شفنا أكثر من منظور للسعودة في المملكة، حبينا نشوف أهم القطاعات القريبة منا وكيف تتحقق نسب السعودة العالية.",
                ],
                style={"marginTop": "20px"},
            ),
        ]
